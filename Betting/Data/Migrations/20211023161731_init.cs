        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorPrimaryColorId = table.Column<int>(type: "int", nullable: true),
                    SecondaryKitColorId = table.Column<int>(type: "int", nullable: true),
                    ColorSecondaryColorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Colors_ColorPrimaryColorId",
                        column: x => x.ColorPrimaryColorId,
                        principalTable: "Colors",
                        principalColumn: "ColorId");
                    table.ForeignKey(
                        name: "FK_Teams_Colors_ColorSecondaryColorId",
                        column: x => x.ColorSecondaryColorId,
                        principalTable: "Colors",
                        principalColumn: "ColorId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AwayTeamGoals = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    HomeTeamGoals = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_ColorPrimaryColorId",
                table: "Teams",
                column: "ColorPrimaryColorId");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_ColorSecondaryColorId",
                table: "Teams",
                column: "ColorSecondaryColorId");
